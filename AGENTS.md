...
- For UI/browser behavior, verify with both script-based Playwright checks and `browser-use:browser` verification in the Codex in-app browser. Include evidence from both surfaces when filing or updating issues.
